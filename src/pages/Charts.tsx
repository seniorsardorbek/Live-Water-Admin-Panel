        ...
        <div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={lineChart.series} options={lineChart.options} className="rounded-lg bg-white dark:bg-black" type="line" height={300} />
                    </div>
        ...
        tooltip: {
            theme: isDark ? 'dark' : 'light',
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={columnChart.series} options={columnChart.options} className="rounded-lg bg-white dark:bg-black" type="bar" height={300} />
                    </div>
...
<ReactApexChart series={simpleColumnStacked.series} options={simpleColumnStacked.options} className="rounded-lg bg-white dark:bg-black" type="bar" height={300} />
        ...
        fill: {
            opacity: 0.8,
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={barChart.series} options={barChart.options} className="rounded-lg bg-white dark:bg-black" type="bar" height={300} />
                    </div>
        ...
        fill: {
            opacity: 0.8,
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={mixedChart.series} options={mixedChart.options} className="rounded-lg bg-white dark:bg-black" type="bar" height={300} />
                    </div>
        ...
        legend: {
            itemMargin: {
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={radarChart.series} options={radarChart.options} className="rounded-lg bg-white dark:bg-black" type="radar" height={300} />
                    </div>
        ...
        legend: {
            position: 'bottom',
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={polarAreaChart.series} options={polarAreaChart.options} className="rounded-lg bg-white dark:bg-black" type="polarArea" height={300} />
                    </div>
        ...
        fill: {
            opacity: 0.85,
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={radialBarChart.series} options={radialBarChart.options} className="rounded-lg bg-white dark:bg-black" type="radialBar" height={300} />
                    </div>
        ...
        fill: {
            opacity: 0.85,
                ...
                <div className="panel">
                    ...
                    <div className="mb-5">
                        <ReactApexChart series={bubbleChart.series} options={bubbleChart.options} className="rounded-lg bg-white dark:bg-black" type="bubble" height={300} />
                    </div>
