                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:mb-5">
                            ...
                            <div className="panel">
                                <div className="flex items-center font-semibold mb-5">
                                    <div className="w-10 h-10 bg-warning rounded-full grid place-content-center p-2">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="100%"
                                            height="100%"
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
                            ...
                            <div className="panel">
                                <div className="flex items-center font-semibold mb-5">
                                    <div className="w-10 h-10 bg-warning rounded-full p-2 grid place-content-center">
